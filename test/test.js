...
describe('CSV parser with postfix', function () {
    ...
    describe('parser', function () {
        it('empty', function () {
            assert_1.default.equal(parser_1.default(``), ``);
        });
        it('linked forward', function () {
            assert_1.default.equal(parser_1.default(`b2,,1
1,c3,1
1,1,5`), `5,0,1
1,5,1
1,1,5`);
        ...
        it('linked back', function () {
            assert_1.default.equal(parser_1.default(`5,,1
1,a1,1
1,1,b2`), `5,0,1
1,5,1
1,1,5`);
        ...
        it('sample', function () {
            assert_1.default.equal(parser_1.default(`b1 b2 +,2 b2 3 * -,3 ,+
a1,5 ,,7 2/
